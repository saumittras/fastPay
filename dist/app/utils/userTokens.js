...
const createUserTokens = (user) => {
    ...
    const refreshToken = (0, jwt_1.generateToken)(jwtPayload, env_1.envVars.JWT_REFRESH_SECRET, env_1.envVars.JWT_REFRESH_EXPIRE);
    return {
        accessToken,
        refreshToken,
    };
...
const createNewAccessTokenWithRefreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield user_model_1.User.findOne({ phone: verifiedRefreshToken.phone });
    if (!isUserExist) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "User Does Not Exist");
    }
    if (isUserExist.isActive === user_interface_1.AccountStatus.BLOCKED ||
        isUserExist.isActive === user_interface_1.AccountStatus.CLOSED) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, `User is ${isUserExist.isActive}`);
    }
    if (isUserExist.isActive === user_interface_1.AccountStatus.DELETED) {
